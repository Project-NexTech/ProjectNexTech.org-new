...
export const getTeamImages = (name: string): string[] => {
  const imageMap: Record<string, string[]> = {
    ...
    'Colin Thompson': ['/img/team/colin_thompson.png', '/img/team/ct_1.png', '/img/team/ct_2.png', '/img/team/ct_3.png', '/img/team/ct_4.png'],
    ...
    'Pryya "Sompan" Surarujiroj': ['/img/team/pryya_surarujiroj.png', '/img/team/ss_1.png', '/img/team/ss_2.png', '/img/team/ss_3.png', '/img/team/ss_4.png', '/img/team/ss_5.png'],
    ...
    'Kausik Ray Chaudhuri': ['/img/team/kausik_ray_chaudhuri.png'],
