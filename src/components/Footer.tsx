      ...
      <Box sx={{ maxWidth: 1800, mx: 'auto', width: '100%' }}>
        ...
        >
          ...
          <Box sx={{ minWidth: 250, textAlign: 'right', display: { xs: 'none', sm: 'flex' }, justifyContent: 'flex-end', alignItems: 'center', pr: { xs: 0, md: 2 } }}>
            <IconButton color="inherit" href="https://www.facebook.com/profile.php?id=61560717552719" target="_blank" sx={{ color: '#fff' }}><FacebookIcon /></IconButton>
            <IconButton color="inherit" href="https://www.linkedin.com/company/project-nextech" target="_blank" sx={{ color: '#fff' }}><LinkedInIcon /></IconButton>
            <IconButton color="inherit" href="https://www.instagram.com/projectnextech/" target="_blank" sx={{ color: '#fff' }}><InstagramIcon /></IconButton>
            <IconButton color="inherit" href="https://www.youtube.com/@ProjectNexTech" target="_blank" sx={{ color: '#fff' }}><YouTubeIcon /></IconButton>
          </Box>
        </Box>
      </Box>
      <Typography variant="body2" sx={{ fontFamily: 'Inter, Arial, sans-serif', color: '#b0b0b0', textAlign: 'center', paddingTop: 3}}>&copy; 2026 Project NexTech, Inc. All rights reserved.</Typography>
  </Box>
);
